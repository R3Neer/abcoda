...
| CAP-03 | ABC suministrado directamente | parity-proven | `CanonicalAbcCodec`, `EvaluateScore`, adaptador schema 1 y contrato workerd preservan el corpus con source maps y round-trip; tunebooks siguen rechazados explícitamente | Ampliar corpus al incorporar nuevas construcciones reales. |
| CAP-04 | Normalización y diagnósticos mecánicos | parity-proven | Diagnósticos estructurales/métricos/referenciales con rango y corrección, normalización identificable e idempotente, y separación entre parseo aceptado y consistencia mecánica | Mantener casos límite del corpus como regresiones. |
...
| CAP-10 | Transposición de ABC, tonalidad y acordes | parity-proven | Operación canónica propia transpone notas, acordes escritos, símbolos y `K:`; inversa restaura el corpus de propiedad y la UI conserva revisión explícita | Ampliar ortografías enarmónicas solo con casos reales. |
| CAP-11 | Percusión inmune a transposición tonal | parity-proven | Operación canónica excluye voces no afinadas; fixture mixto conserva `K:none clef=perc`, notas y kit, con unitarias y Playwright | Audición humana del mapa GM permanece como calidad continua. |
...
| CAP-18 | Claves, transposición sonora y claves de octava | parity-proven | Modelo conserva `clef`, `treble-8`, cambios inline y `transpose=`; caracterización abcjs evita doble octava y codec round-trips/transpone sin alterar esas directivas | Mantener audición humana como control continuo. |
