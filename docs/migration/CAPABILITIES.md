...
| CAP-06 | Play, pause, rewind y loop | partial | Máquina v2 discriminada y `AbcjsPlaybackEngine` diferido, con continuidad, teardown y carreras probadas | Conexión al grabado, controles y navegador con gesto humano. |
