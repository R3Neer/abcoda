...
| CAP-03 | ABC suministrado directamente | implemented-v2 | `EvaluateScore`, adaptador schema 1, contrato workerd y escenario Playwright legacy conservan fuente, voces y presentación | Alcanzar paridad mecánica al completar codec/corpus. |
