/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc apps/worker/worker-configuration.d.ts` (hash: 66ad6649d027e0f80623b6d5b4ea06de)
// Runtime types generated with workerd@1.20260811.1 2026-08-15 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	ALLOWED_ORIGINS: "https://chatgpt.com,https://chat.openai.com,http://localhost:5173,http://127.0.0.1:5173";
}
